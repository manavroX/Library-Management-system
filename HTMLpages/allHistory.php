 <?php  
    ...
    $sql = "SELECT r.accession_id,b.name,r.issue_date,r.due_date,COALESCE(r.return_date,'not returned')  FROM record r,book b,copy c where 
    r.gr_no=c.gr_no and  r.copy_no=c.copy_no  and b.gr_no=c.gr_no order by r.return_date,r.due_date desc ";
 ...
 <?php 
				...
				<?php
						endforeach;
							...
							echo " <tr><td colspan=\"5\">nothing to show as no one has read any book yet!!</td></tr>";
						 endif;
